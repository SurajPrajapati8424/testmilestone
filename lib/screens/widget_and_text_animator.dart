...
class WidgetTextAnimator extends StatelessWidget {
  const WidgetTextAnimator({super.key});
          ...
          children: [
            ...
            WidgetAnimator(
              ...
              child: GestureAnimator(
                ...
                onLongPress: () {
                  debugPrint('on long press triggered');
                },
                onTap: () {
...
class SamplesIncoming extends StatefulWidget {
  const SamplesIncoming({super.key});
...
class SamplesOutgoing extends StatefulWidget {
  const SamplesOutgoing({super.key});
...
class _OutgoingSlideOutBottomCustomCurve extends StatefulWidget {
  const _OutgoingSlideOutBottomCustomCurve();
...
class _OutgoingRotationClockwise extends StatefulWidget {
  const _OutgoingRotationClockwise();
...
class _OutgoingRotationAntiClockwise extends StatefulWidget {
  const _OutgoingRotationAntiClockwise();
...
class _OutgoingOffsetThenScale extends StatefulWidget {
  const _OutgoingOffsetThenScale();
