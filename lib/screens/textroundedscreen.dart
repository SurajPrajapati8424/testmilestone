...
class TextRoundedScreen extends StatefulWidget {
  const TextRoundedScreen({super.key});

  @override
  State<TextRoundedScreen> createState() => _TextRoundedScreenState();
}

class _TextRoundedScreenState extends State<TextRoundedScreen> {
