...
class FlutterAnimationScreen extends StatefulWidget {
  const FlutterAnimationScreen({super.key});
  ...
  @override
  State<FlutterAnimationScreen> createState() => _FlutterAnimationScreenState();
}

class _FlutterAnimationScreenState extends State<FlutterAnimationScreen> {
  int _viewIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          for (final tab in FlutterAnimationScreen.tabs)
      ...
      body: DefaultTextStyle(
        ...
        child: SafeArea(
          bottom: false,
          child: FlutterAnimationScreen.tabs[_viewIndex].builder(context),
        ),
      ),
    );
  }
